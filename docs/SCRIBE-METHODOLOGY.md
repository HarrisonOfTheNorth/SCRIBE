...
- **/docs/api/specs/** — Detailed specifications (design principles, error handling, technology choices, feature specifications)
- **/docs/api/guides/** — Procedural workflows and how-to guides
- **/docs/api/adr/** — Architecture decision records explaining why key decisions were made
...
**How**: TECHNICAL-SPECIFICATION-SPECULATOR.md (e.g., API-SPECULATOR.md) runs and systematically questions the developer:
...
**How**: Developer executes API-IMPLEMENTATION-PROMPT.md:
1. API-IMPLEMENTATION-PROMPT.md reads all specification markdown files
...
**Implementation is Passive**: Once code is generated by API-IMPLEMENTATION-PROMPT.md, it's complete. The developer does not manually write code. The AI generates everything based on the specifications.
...
**Note**: Additional outputs (getting-started.md, API-RESTORATION-PROMPT.md) are generated as part of API-IMPLEMENTATION-PROMPT.md's 4-part system, not separate phases.
...
- Run API-RESTORATION-PROMPT.md to return to specification-only state
...
1. Run API-RESTORATION-PROMPT.md (removes /src, /tests, generated guides)
2. Refine the specifications
3. Regenerate code using API-IMPLEMENTATION-PROMPT.md
4. Execute again
5. Repeat as needed
...
**What Happens**:
1. Developer executes the selected Speculator (e.g., TECHNICAL-SPECIFICATION-SPECULATOR.md (e.g., API-SPECULATOR.md) for API Speculator)
...
3. Output: 11+ markdown files defining the complete project
   ...
   - /docs/api/specs/ (API design, error handling, technology choices, feature specs)
   - /docs/api/guides/ (getting-started-design, adding-features)
   - /docs/api/adr/ (architecture decision records)
...
**What Happens**:
1. Developer executes API-IMPLEMENTATION-PROMPT.md
...
**Implementation is Passive**: Once API-IMPLEMENTATION-PROMPT.md generates code, it's complete. The developer doesn't manually write code. AI generates everything from the specification.
...
4. AI generates getting-started.md guide (API-IMPLEMENTATION-PROMPT.md Part 3)
5. AI generates API-RESTORATION-PROMPT.md (API-IMPLEMENTATION-PROMPT.md Part 4)
...
3. Run API-RESTORATION-PROMPT.md (returns to specification-only state)
4. Run API-IMPLEMENTATION-PROMPT.md again (regenerates code)
...
- Links to /docs/api/specs/ for detailed requirements
- Links to /docs/api/guides/ for procedural knowledge
- Links to /docs/api/adr/ for architectural decisions
...
**How SCRIBE Uses It**: TECHNICAL-SPECIFICATION-SPECULATOR.md (e.g., API-SPECULATOR.md) is a meta-prompt that generates specification packages. The specification generator itself can be customized or regenerated for different domains.
...
- All project decisions documented in /docs/api/adr/
...
- Run API-IMPLEMENTATION-PROMPT.md Part 1
...
- Use API-RESTORATION-PROMPT.md to restore and iterate
...
For detailed implementation guidance, see your selected Speculator (e.g., API Speculator, Application Speculator, etc.). For architecture decisions, see /docs/api/adr/. For specific project examples, see /docs/api/specs/.
