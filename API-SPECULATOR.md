...
- Restoration: restoration-prompt.md cleaned all generated artifacts, returned to specification-only state
...
- **IMPLEMENTATION-PROMPT.md**: 4-part code generation system (adapted to your project)

### Documentation Directory (/docs/)
- **/docs/specs/**: Project specifications (API design, error handling, technology choices, first features)
- **/docs/guides/**: Procedural guides (getting-started design, adding-features workflow)
- **/docs/adr/**: Architecture decision records (your project's first decision)
...
### Template: /docs/specs/api-design.md (for APIs)
```
...
### Template: /docs/specs/[first-feature].md
```
...
### Template: /docs/specs/technology-choices.md
```
...
### Template: /docs/specs/error-handling.md
```
...
### Template: /docs/guides/adding-features.md
```
...
### Template: /docs/guides/getting-started-design.md
```
...
### Template: /docs/adr/adr-001-[decision].md
```
...
All ready for IMPLEMENTATION-PROMPT.md to generate working code.
