...
- **API Speculator** (e.g., [API-SPECULATOR.md](./API-SPECULATOR.md)) works for ALL API projects (REST, GraphQL, gRPC, etc.)
...
- **API-IMPLEMENTATION-PROMPT.md** — The code generation prompt (execute this to generate source code)
...
**Additionally generated by API-IMPLEMENTATION-PROMPT.md** (after code is built and tested):
- **API-CLAUDE.md** — Claude Code agent guidance specific to the generated project (build commands, coding standards, workflows, gotchas)
...
**Note**: Additional outputs (getting-started.md, API-RESTORATION-PROMPT.md, API-CLAUDE.md) are generated as part of API-IMPLEMENTATION-PROMPT.md's 5-part system, not separate phases.
...
3. Output: 11+ markdown files defining the complete project
   - API-IMPLEMENTATION-PROMPT.md (the code generation prompt)
   ...
   - Note: API-CLAUDE.md is generated later by API-IMPLEMENTATION-PROMPT.md, not at this phase
...
6. AI generates API-CLAUDE.md — Claude Code agent guidance specific to the generated project
...
- Implementation validated against specifications
- API-CLAUDE.md — Claude Code agent guidance for the generated project
