...
- **IMPLEMENTATION-PROMPT.md** — The code generation prompt (execute this to generate source code)
...
**Additionally generated by IMPLEMENTATION-PROMPT.md** (after code is built and tested):
...
3. Output: 11+ markdown files defining the complete project
   - IMPLEMENTATION-PROMPT.md (the code generation prompt)
   ...
   - Note: API-CLAUDE.md is generated later by IMPLEMENTATION-PROMPT.md, not at this phase
